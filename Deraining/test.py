...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', default='./pretrained_models/net_g_derain_fine.pth', type=str,help='Path to weights')# net_g_derain_coarse.pth

    args = parser.parse_args()

    ####### Load yaml #######
    yaml_file = 'Options/Deraining_C2F-DFT_Fine.yml'
    # yaml_file = 'Options/Deraining_C2F-DFT_Coarse.yml'
    ...
    datasets = ['Rain100L', 'Rain100H', 'Test100', 'Test2800']
